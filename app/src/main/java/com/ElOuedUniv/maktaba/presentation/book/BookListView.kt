...
fun BookListView(
    ...
    // Exercise 1 & 3: Use a single delegated uiState from the ViewModel
    val uiState by viewModel.uiState.collectAsState()
    val context = LocalContext.current

    // Exercise 3: Observe one-time UI events (e.g. snackbar, navigation)
    LaunchedEffect(Unit) {
    ...
    // Exercise 4: Show AddBookDialog when uiState.isAddingBook is true
    ...
    Scaffold(
        ...
        floatingActionButton = {
            // Exercise 3: Connect FAB click to OnAddBookClick action
        ...
        Box(
            ...
            // Exercise 1: Read loading & books from the single uiState
